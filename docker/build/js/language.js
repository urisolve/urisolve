...
$(function () {
    ...
    dictionary = {
        "english": {
            ...
            "_passiveInfo2": 'To use this mode, click on the "Calculate" button. The circuit will be solved automatically using the Branch Current Method. This mode is ideal for those looking for a quick solution, without having to adjust resolution parameters.',
        ...
        "portuguese": {
            ...
            "_passiveInfo2": 'Para utilizar este modo, basta clicar no botão "Calcular". O circuito será resolvido automaticamente utilizando o Método da Corrente nos Ramos. Este modo é ideal para quem procura uma solução rápida, sem precisar de ajustar parâmetros de resolução.',
