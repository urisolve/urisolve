...
$(function () {
    ...
    dictionary = {
        "english": {
            ...
            "_mainTab": "Main",
            "_resultsTab": "Results",
            "_tableContTitle": "Resolution:",
            "_selectionTitle": "Selection of Resolution Method",
            "_passiveTab": "Automatic",
            "_interactiveTab": "Manual",
            "_passiveInfo1": 'Automatic mode allows you to solve circuits didactically, without the possibility of selecting the order or method of solving subcircuits.',
            "_passiveInfo2": 'To use this mode, click on the "Analyze" button. The circuit will be solved automatically using the Branch Current Method. This mode is ideal for those looking for a quick solution, without having to adjust resolution parameters.',
            "_interactiveInfo1": 'The manual mode allows you to select the order and solving method for each source in the circuit.',
            "_interactiveInfo2": 'To use this mode:',
            "_interactiveInfo3": 'Manual mode allows for more customization when solving the circuit, allowing you to select the most appropriate order and method of resolution for each source.',
            ...
            "_interactiveStep4": '4. When you are satisfied with the selected order and methods, press the "Analyze" button to obtain the results.',
            "_numsources": "Selected sources: ",
            "_tspNotes1": 'Note: This circuit was obtained by removing the remaining voltage and current sources, according to the Superposition Theorem:',
            "_tspNotesRi": " was replaced by its internal resistance.",
            "_tspNotesIdeal": " has zero internal resistance, therefore, it is an ideal source.",
            "_tspNotesCC": " So, it is replaced by a short circuit, ensuring zero voltage.",
            "_tspNotesCA": " So, it is replaced by an open circuit, ensuring zero current.",
            "_btn_calcTSP": "Analyze",
            ...
            "_TSPmethod": "Superposition Theorem",
            "_TSPabstract": "This document provides a step by step solution for the submitted circuit, using the Superposition Theorem (TSP).",
        ...
        "portuguese": {
            ...
            "_tableContTitle": "Resolução:",
            "_selectionTitle": "Seleção do método de resolução",
            "_passiveTab": "Automático",
            "_interactiveTab": "Manual",
            "_passiveInfo1": 'O modo automático permite resolver circuitos didaticamente, sem a possibilidade de selecionar a ordem ou método de resolução dos subcircuitos.',
            "_passiveInfo2": 'Para utilizar este modo, basta clicar no botão "Analisar". O circuito será resolvido automaticamente utilizando o Método da Corrente nos Ramos. Este modo é ideal para quem procura uma solução rápida, sem precisar de ajustar parâmetros de resolução.',
            "_interactiveInfo1": 'O modo manual permite selecionar a ordem e método de resolução para cada fonte do circuito.',
            "_interactiveInfo2": 'Para utilizar este modo:',
            "_interactiveInfo3": 'O modo manual permite uma maior personalização na resolução do circuito, permitindo a seleção da ordem e método de resolução mais adequados para cada fonte.',
            "_interactiveStep1": '1. Selecione as fontes na imagem do circuito, acima, para adicioná-las ou removê-las da ordem de resolução que estará presente abaixo',
            "_interactiveStep2": '2. Em seguida, é possível arrastar elementos na ordem para reorganizá-los mais facilmente',
            "_interactiveStep3": '3. Selecione o método de resolução de cada circuito parcelar individualmente através do respetivo menu suspenso.',
            "_interactiveStep4": '4. Quando estiver satisfeito com a ordem e os métodos selecionados, pressione o botão "Analisar" para obter os resultados.',
            "_numsources": "Fontes selecionadas: ",
            "_tspNotes1": 'Nota: este circuito foi obtido ao remover as restantes fontes de tensão e corrente, de acordo com o Teorema da Sobreposição:',
            "_tspNotesRi": " foi substuída pela sua resistência interna.",
            "_tspNotesIdeal": " tem resistência interna nula, logo, é uma fonte ideal.",
            "_tspNotesCC": " Então, é substituída por um curto-circuito, garantindo tensão nula.",
            "_tspNotesCA": " Então, é substituída por um circuito aberto, garantindo corrente nula.",
            "_tspNotesSum": "Nota: cada corrente é obtida através da soma algébrica das contribuições de cada fonte.",
            "_tspNotesSumComplex": "Nota: cada corrente é obtida através da soma algébrica das contribuições de cada fonte, sendo estas números complexos, recomenda-se a utilização da calculadora ou transformação para coordenadas algébricas.",
            "_btn_calcTSP": "Analisar",
            ...
            "_TSPmethod": "Teorema da Sobreposição",
            "_TSPabstract": "Este documento fornece uma solução passo a passo para o circuito submetido, usando o Teorema da Sobreposição (TSP)",
