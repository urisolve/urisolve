 ...
 */
function buildPrintPDFMCR(file, meshImages, nodeImages, name,lastname,number){
    ...
    //print head
    doc = printBuildHeadMCR(doc, lang,name,lastname,number);
 ...
 */
function printBuildHeadMCR(doc, lang,name,lastname,number){
    let line = 170;
    ...
    doc.text(lang._MCRmethod, width/2, line+=20, null, null, 'center');
    ...
    doc.setFontSize(10);
    if(number!=""){
    doc.text(name +' '+ lastname+' ('+number+')', width/2, line+=40, null, null, 'center');}
