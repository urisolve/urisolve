...
const adjL1 = [0,1,1,1,1];
const adjL2 = [1,0,1,0,1];
const adjL3 = [1,1,0,1,0];
const adjL4 = [1,0,1,0,1];
const adjL5 = [1,1,0,1,0];

let adjacencyMatrix = math.matrix([adjL1, adjL2, adjL3, adjL4, adjL5]);

console.table(adjacencyMatrix._data);

const branches = ["r1", "r2", "r3", "r4", "r5", "r6", "r7", "r8","r9"];
const incL1 = [1,1,0,0,1,1,0,1,0];
const incL2 = [0,0,1,0,0,1,1,0,0];
const incL3 = [0,0,0,0,0,0,1,1,1];
const incL4 = [0,0,0,1,1,0,0,0,1];
const incL5 = [1,1,1,1,0,0,0,0,0];
